...
"Can you edit the multiply function in utils.py to multiply by 3 instead of 2?"`,
  ...
  { id: 5, from: "context_builder", to: "context_builder",
    label: "Project Memory: loaded", type: "context_source", durationMs: 500,
    data: `Project-level agent-managed memories from .claraity/memory/MEMORY.md.`,
    sections: { "Project Memory": "# ClarAIty Agent Memory\n\n## Architecture Decisions\n- [No Session Redaction](no-session-redaction.md) -- Secret redaction removed\n- [Multi-Root Workspace](multi-root-workspace.md) -- Multi-folder workspace support" } },
  { id: 6, from: "context_builder", to: "context_builder",
    label: "User Memory: loaded", type: "context_source", durationMs: 500,
    data: `User-level agent-managed memories from ~/.claraity/memory/MEMORY.md.`,
    sections: { "User Memory": "# User Memory\n\n## Preferences\n- Explain before implementing\n- Match Roo Code polish level\n- Assess every request as a tech lead" } },
  { id: 7, from: "context_builder", to: "store",
    label: "Fetch conversation (1 msg)", type: "context_source", durationMs: 600,
    data: `Reading from MessageStore (in-memory):\n\n1 user\n\nTotal messages: 1` },
  { id: 8, from: "store", to: "context_builder",
    label: "Returned 1 message", type: "context_source", durationMs: 500,
    data: `Conversation history returned from in-memory store.\n\nMessages: 1\nEstimated tokens: 45` },
  // ── Step 9: Context ready → LLM call #1 ──
  { id: 9, from: "agent", to: "context_builder", label: "Context ready (3 msgs) (iter 1)", type: "context_assembly", durationMs: 600,
    data: `Sending to LLM:\n\n1 system, 1 user\n\nTotal messages: 3` },
  { id: 10, from: "context_builder", to: "llm", label: "LLM call #1 (iter 1)", type: "llm_call", durationMs: 1800,
  ...
  { id: 11, from: "llm", to: "agent", label: "Tool call: read_file", type: "llm_response", durationMs: 1200,
  ...
  { id: 12, from: "agent", to: "gating", label: "Gate check: read_file (iter 1)", type: "gate_check", durationMs: 900,
    data: `Tools entering 3-check pipeline:\n\n  [1] read_file\n\nChecks: repeat -> plan_mode -> approval\nResult: ALLOW (auto-approved read)` },
  { id: 13, from: "gating", to: "tools", label: "Approved: read_file (iter 1)", type: "tool_execute", durationMs: 800,
    data: `read_file({ "path": "utils.py" })` },
  { id: 14, from: "tools", to: "agent", label: "Results: read_file (iter 1)", type: "tool_result", durationMs: 1000,
    data: `[read_file]\ndef add(x, y):\n    return x + y\n\ndef multiply(x, y):\n    """Multiply x by 2."""\n    return x * 2\n\ndef subtract(x, y):\n    return x - y` },
  // ══ ITERATION 2: edit_file ════════════════════════════════════════════════
  { id: 15, from: "agent", to: "context_builder", label: "Context ready (5 msgs) (iter 2)", type: "context_assembly", durationMs: 700,
    data: `Sending to LLM:\n\n1 system, 1 user, 1 assistant, 1 tool\n\nTotal messages: 5` },
  { id: 16, from: "context_builder", to: "llm", label: "LLM call #2 (iter 2)", type: "llm_call", durationMs: 1600,
  ...
  { id: 17, from: "llm", to: "agent", label: "Tool call: edit_file", type: "llm_response", durationMs: 1200,
  ...
  { id: 18, from: "agent", to: "gating", label: "Gate check: edit_file (iter 2)", type: "gate_check", durationMs: 900,
    data: `Tools entering 3-check pipeline:\n\n  [1] edit_file\n\nChecks: repeat -> plan_mode -> approval\nResult: NEEDS_APPROVAL (write operation)` },
  // ── Approval flow: Gating asks User, User approves ──
  { id: 19, from: "gating", to: "user", label: "Approval required: edit_file", type: "approval", durationMs: 1200,
  ...
  { id: 20, from: "user", to: "gating", label: "User approved edit_file", type: "approval", durationMs: 800,
    data: `Decision: APPROVED\nWait time: 2.3s\n\nTool execution will proceed.` },
  { id: 21, from: "gating", to: "tools", label: "Approved: edit_file (iter 2)", type: "tool_execute", durationMs: 800,
    data: `edit_file({ "path": "utils.py", "old_string": "    return x * 2", "new_string": "    return x * 3" })` },
  { id: 22, from: "tools", to: "agent", label: "Results: edit_file (iter 2)", type: "tool_result", durationMs: 900,
    data: `[edit_file]\nSuccess -- 1 change applied.\nFile: utils.py\nLines changed: 1 (line 8)` },
  // ══ ITERATION 3: final response ═══════════════════════════════════════════
  { id: 23, from: "agent", to: "context_builder", label: "Context ready (7 msgs) (iter 3)", type: "context_assembly", durationMs: 700,
    data: `Sending to LLM:\n\n1 system, 1 user, 2 assistant, 2 tool\n\nTotal messages: 7` },
  { id: 24, from: "context_builder", to: "llm", label: "LLM call #3 (iter 3)", type: "llm_call", durationMs: 1400,
  ...
  { id: 25, from: "llm", to: "agent", label: "Final text response", type: "llm_response", durationMs: 1200,
  ...
  // ══ TURN END ══════════════════════════════════════════════════════════════
  { id: 26, from: "agent", to: "store", label: "Session persisted", type: "persist", durationMs: 900,
    data: `MessageStore updated (in-memory) + appended to:\n.claraity/sessions/sess_20240402.jsonl\n\nAppended 8 messages` },
  { id: 27, from: "agent", to: "user", label: "Response delivered", type: "request", durationMs: 800,
...
const CB_SOURCES = [
  ...
  { label: "Project Memory", key: "Project Memory" },
  { label: "User Memory",    key: "User Memory" },
] as const;
