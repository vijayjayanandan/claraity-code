...
Usage:
    ...
    result = hydrator.hydrate(Path(".claraity/sessions/abc123/session.jsonl"))
...
class SessionHydrator:
    ...
    def hydrate(self, jsonl_path: Path, on_progress: Callable | None = None) -> HydrationResult:
        ...
        # Supports both: .claraity/sessions/abc123/session.jsonl and .claraity/sessions/abc123.jsonl
