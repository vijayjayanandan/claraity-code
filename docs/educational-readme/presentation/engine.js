...
(function () {
    ...
    function renderLayerStack() {
        var layers = [
            ...
            { label: 'Task Tracking',       desc: 'Ch 12 — Planning work',     color: '#8B5CF6' },
            { label: 'Knowledge Graph',     desc: 'Ch 11 — Codebase map',      color: '#7C3AED' },
            { label: 'MCP',                 desc: 'Ch 10 — External tools',    color: '#A855F7' },
            { label: 'Context Compaction',  desc: 'Ch 9 — Managing limits',    color: '#EC4899' },
            { label: 'Error Recovery',      desc: 'Ch 8 — Handling failures',  color: '#F43F5E' },
            { label: 'Streaming UX',        desc: 'Ch 7 — Real-time output',   color: '#F59E0B' },
            { label: 'Agent Loop',          desc: 'Ch 6 — Orchestration',      color: '#EAB308' },
            { label: 'Session Persistence', desc: 'Ch 5 — Saving history',     color: '#22C55E' },
            { label: 'Tool Gating',         desc: 'Ch 4 — Safety checks',      color: '#10B981' },
    ...
    function renderCompleteFlow() {
        var steps = [
            ...
            { label: 'Execute: built-in or MCP (Ch 3 & 10)',      color: '#14B8A6' },
