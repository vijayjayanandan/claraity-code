...
class SubAgentManager:
    def discover_subagents(self) -> Dict[str, SubAgentConfig]:
        """Discover configs from ~/.claude/agents and .claude/agents."""
...
2. Project directory: `.claude/agents/*.md` (higher priority, can override)
...
| Subagent configs | `.claude/agents/*.md` |
